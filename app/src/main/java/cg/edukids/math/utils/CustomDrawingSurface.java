...
public class CustomDrawingSurface extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (inkBuilder == null) {
                    inkBuilder = Ink.builder(); // Inițializează doar o singură dată
                }
            ...
            case MotionEvent.ACTION_MOVE:
                if (currentStroke != null) {
                    currentStroke.addPoint(Ink.Point.create(x, y, System.currentTimeMillis()));
                    drawPath.lineTo(x, y); // Adaugă punct în desen
                }
                break;
            ...
            case MotionEvent.ACTION_UP:
                if (currentStroke != null) {
                    ...
                    currentStroke = null; // Resetăm stroke-ul
                    drawCanvas.drawPath(drawPath, drawPaint); // Desenează pe canvas
                    drawPath.reset(); // Resetează calea de desen
                }
                break;
        }

        invalidate(); // Re-desenează canvas-ul
        return true;
    }
    ...
    public void setInk(Ink newInk) {
        ...
        invalidate(); // Re-desenăm canvas-ul pentru a reflecta schimbarea
    }
